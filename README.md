...
__This is a fork of the original repository! There are many significant and specific changes made by me.__
...
helm lint .
helm install my-release . --namespace=memcached --create-namespace
